	...
	<div class="container">
		...
		<div class="row">
			<?php foreach ($allProducts as $product) : ?>
				<div class="col-md-3">
					<div class="menu-entry">
						<a href="products/product-single.php?id=<?php echo $product->id; ?>" class="img" style="background-image: url(images/<?php echo $product->image; ?>);"></a>
						<div class="text text-center pt-4">
							<h3><a href="products/product-single.php?id=<?php echo $product->id; ?>"><?php echo $product->name; ?></a></h3>
							<p><?php echo $product->description; ?></p>
							<p class="price"><span><?php echo $product->price . "€"; ?></span></p>
							<p><a href="products/product-single.php?id=<?php echo $product->id; ?>" class="btn btn-primary btn-outline-primary">Show</a></p>
						</div>
					</div>
				</div>
			<?php endforeach ?>
